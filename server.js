...
<body>
  ...
  (function(){
    ...
    function run(){
      ...
      fitOneLine(document.querySelector('.line.nom'),    { minScale:0.50, grow:1.90, padPx:2 });
      // PRÉNOM: inchangé (ne grandit pas)
      fitOneLine(document.querySelector('.line.prenom'), { minScale:0.55, grow:1.90, padPx:2 });
