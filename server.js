...
<body>
  ...
  (function(){
    ...
    function run(){
      ...
      fitOneLine(document.querySelector('.line.nom'),    { minScale:0.50, grow:4.00, padPx:8 });
      // PRÉNOM: inchangé (ne grandit pas)
      fitOneLine(document.querySelector('.line.prenom'), { minScale:0.55, grow:4.00, padPx:8 });
