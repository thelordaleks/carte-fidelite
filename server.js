...
<body>
  ...
  (function(){
    ...
    function run(){
      ...
      fitOneLine(document.querySelector('.line.nom'),    { minScale:0.50, grow:100.00, padPx:3 });
      // PRÉNOM: inchangé (ne grandit pas)
      fitOneLine(document.querySelector('.line.prenom'), { minScale:0.55, grow:100.00, padPx:3 });
